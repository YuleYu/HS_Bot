...
namespace HREngine.Bots
{
    ...
    public class BehaviorControl : Behavior
    {
        ...
        public override float getPlayfieldValue(Playfield p)
        {
            ...
            {
                if (p.ownWeaponAttack > 1) retval += p.ownWeaponAttack * p.ownWeaponDurability;
                else retval += p.ownWeaponAttack * p.ownWeaponDurability + 1;
            }
            ...
            if (p.owncarddraw + 1 >= p.enemycarddraw) retval -= p.enemycarddraw * 8;
            else retval -= p.enemycarddraw * 15;
