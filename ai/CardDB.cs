    ...
    public class CardDB
    {
        ...
        public class Card
        {
            ...
            public List<Minion> getTargetsForCard(Playfield p, bool isLethalCheck, bool own)
            {
                ...
                if (isLethalCheck) 
                {
                    ...
                    {
                        if (PenalityManager.Instance.attackBuffDatabase.ContainsKey(this.name))
                        {
                    ...
                    else if (this.type == cardtype.MOB)
                    {
                        foreach (Minion m in targets)
                        {
            ...
            public int getManaCost(Playfield p, int currentcost)
            {
                ...
                switch (this.type)
                {
                    ...
                    case cardtype.MOB:
                        ...
                        if (p.soeldnerDerVenture != p.startedWithsoeldnerDerVenture)
                        {
                    ...
                    case cardtype.SPELL:
                        ...
                        if (p.startedWithallSpellCostLess != p.allSpellCostLess)
                        {
                            offset += p.startedWithallSpellCostLess - p.allSpellCostLess;
                        }

                        
                        if (p.anzOwnsorcerersapprentice != p.anzOwnsorcerersapprenticeStarted)
                        {
        ...
        public SimTemplate getSimCard(cardIDEnum id)
        {
            switch (id)
            {
                ...
                /*case cardIDEnum.BRMA02_2_2c_TB:
                    return new Sim_BRMA02_2_2c_TB();
                case cardIDEnum.BRMA07_2_2c_TB:
                    return new Sim_BRMA07_2_2c_TB();
                case cardIDEnum.HRW02_1e:
                    return new Sim_HRW02_1e();
                case cardIDEnum.NAX12_02H_2c_TB:
                    return new Sim_NAX12_02H_2c_TB();
                case cardIDEnum.TB_CoOpBossSpell_1:
                    return new Sim_TB_CoOpBossSpell_1();
                case cardIDEnum.TB_CoOpBossSpell_2:
                    return new Sim_TB_CoOpBossSpell_2();
                case cardIDEnum.TB_CoOpBossSpell_3:
                    return new Sim_TB_CoOpBossSpell_3();
                case cardIDEnum.TB_CoOpBossSpell_4:
                    return new Sim_TB_CoOpBossSpell_4();
                case cardIDEnum.TB_CoOpBossSpell_5:
                    return new Sim_TB_CoOpBossSpell_5();
                case cardIDEnum.TB_CoOpBossSpell_6:
                    return new Sim_TB_CoOpBossSpell_6();
                case cardIDEnum.TB_CoOp_Mechazod:
                    return new Sim_TB_CoOp_Mechazod();
                case cardIDEnum.TB_FactionWar_BoomBot:
                    return new Sim_TB_FactionWar_BoomBot();
                case cardIDEnum.TB_FactionWar_BoomBot_Spell:
                    return new Sim_TB_FactionWar_BoomBot_Spell();
                case cardIDEnum.TB_FactionWar_Boss_BoomBot:
                    return new Sim_TB_FactionWar_Boss_BoomBot();
                case cardIDEnum.TB_GreatCurves_01:
                    return new Sim_TB_GreatCurves_01();
                case cardIDEnum.TB_MechWar_Boss1:
                    return new Sim_TB_MechWar_Boss1();
                case cardIDEnum.TB_MechWar_Boss1_HeroPower:
                    return new Sim_TB_MechWar_Boss1_HeroPower();
                case cardIDEnum.TB_MechWar_Boss2:
                    return new Sim_TB_MechWar_Boss2();
                case cardIDEnum.TB_MechWar_Boss2_HeroPower:
                    return new Sim_TB_MechWar_Boss2_HeroPower();
                case cardIDEnum.TB_MechWar_CommonCards:
                    return new Sim_TB_MechWar_CommonCards();
                case cardIDEnum.TB_RandCardCost:
                    return new Sim_TB_RandCardCost();
                case cardIDEnum.TB_RandHero2_001:
                    return new Sim_TB_RandHero2_001();
                case cardIDEnum.TB_RMC_001:
